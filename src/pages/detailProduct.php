...
if (isset($_GET['ProductID'])) {
    ...
    $result_shop = $mysqli->query($query_shop);
    $result_booktype = $mysqli->query($query_booktype);
...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="../assets/icon/font awesome/fontawesome-free-5.15.4-web/css/all.css">
    ...
    <body>
        ...
        <div class="main-content bg-[#f8eeeea1]  px-[20px] py-[0px] mx-[50px]">
            ...
            <div class="main-product flex  my-[20px]">
                ...
                <div class="img-product py-[16px] pr-0 pl-[16px] ">
                    <!-- ảnh sản phẩm -->
                    <img class=" w-[444px]" src="../../Uploads/<?php echo $row_products['Image']; ?> ">
                    ...
                    <div class="bg-[#f8eeeea1]  mt-[80px]">
                        ...
                        <img src="../assets/img/img_detailProducts/anh-dong-cute-cho-powerpoint_105545111.gif" class="w-[200px] " alt="">
                    </div>
                </div>
                ...
                <div class="about-product py-[16px] pr-[28px]  pl-0">
                    ...
                    <div class="flex">
                        <div class="w-2/3">
                            <!-- giá bán -->
                            <h1 class="  inline-block font-medium text-[40px]  text-red-500  m-[12px]"><?php echo convertMoney($row_products['Price']); ?> ₫</h1>
                            <del class=" text-[20px] inline-block font-[100]"><?php echo convertMoney($row_products['OldPrice']); ?> đ</del>
                            <div class=" h-[30px] w-2/5 flex space-x-3  border-2 border-[#b9b4b4] bg-[#e1e9f1]">
                                ...
                                <!-- lưu trữ thông tin  -->
                                <img class="w-[42px] cursor-pointer" src="../assets/img/img_detailProducts/d74d0e9e37a9bb14f35dcc0c816d2038.gif" alt="">
                            </div>
        ...
        underline cursor-pointer py-[12px]">Q.hoàn kiếm ,P.Hàng Trống , Hà Nội
                            ...
                            <form action="./addCarts.php?productid=<?php echo $row_products['ProductID'] ?> " method="post">
                                <div class="flex text-[35px] items-center my-[10px]">
                                    ...
                                    <input type="number" name="soluongmua" id="number-input" class="inline-block w-[60px] h-[40px] text-[20px] border-solid border border-[#e3e6ef] text-center leading-[30px] py-[1px] px-[2px]" value="1" min="1">
                                ...
                                <div class="flex mt-[60px] ">
                                    ...
                                    <button type="submit" class="  w-2/3 font-[500] text-[white] rounded-[10px] bg-[red] text-center leading-[40px] py-[6px] hover:bg-[#585252] cursor-pointer">Chọn Mua
                                    </button>
                                </div>
                            </form>
                        ...
                        <div class="border-solid border border-[#e3e6ef] w-1/3 home-book py-[8px] px-[12px] my-[12px]">
                            <div class="flex">
                                <img src="../admin/shop_img/<?php echo $row_shop['shop_img']; ?>" alt="" class=" w-[60px]">
                            ...
                            <div class="">
                                <img src="../assets/img/img_detailProducts/anh-dong-cute-ban-tim_105545064.gif" alt="">
                            </div>
                        </div>
                    </div>
                ...
                <div class="product-container flex  relative">
                    ...
                    ?>
                        ...
                        <div class="product grow-0 shrink-0 basis-1/6  hidden hover:shadow-xl">
                            <a href="./detailProduct.php?ProductID=<?php echo $row_relatedProducts['ProductID']; ?>" class=" p-[12px]  cursor-pointer  group ">
                                <img src="../../Uploads/<?php echo $row_relatedProducts['Image']; ?>" alt="">
                                <div class="mx-[12px] pl-[30px]">
                                    <div class="text-[red] text-[18px]"><?php echo convertMoney($row_relatedProducts['Price']); ?> ₫ </div>
            ...
            <div class="Random">
                ...
                <div class="product-container flex  relative">
                    ...
                    ?>
                        <div class="product grow-0 shrink-0 basis-1/6  hidden hover:shadow-xl">
                            <a href="./detailProduct.php?ProductID=<?php echo $row_randomProducts['ProductID']; ?>" class=" p-[12px]  cursor-pointer hover:shadow-xl group ">
                                <img src="../../Uploads/<?php echo $row_randomProducts['Image']; ?>" alt="">
                                <div class="mx-[12px] pl-[30px]">
                                    <div class="text-[red] text-[18px]"><?php echo convertMoney($row_randomProducts['Price']); ?> ₫ </div>
    ...
    <script src="../assets/js/transferProductsRandom.js">

    </script>
    <script src="../assets/js/transferProductRelated.js">
